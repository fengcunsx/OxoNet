...
def prediction(args: argparse.Namespace):
    model, device = build_model(args.resume)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', type=str,
                        default='/home/bio/8oxog/models/3407/model_138.pth')
    ...
    parser.add_argument('--test-work-dir', type=str, default='/home/bio/8oxog/data/test_workspace')
    parser.add_argument('--batch-size', type=int, default=256)
    parser.add_argument('--threshold', type=float, default=0.5)
    parser.add_argument('--num-workers', type=int, default=8)
    parser.add_argument('--save-dir', type=str, default='/home/bio/8oxog/models/3407/best_info.csv')
